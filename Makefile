# This Makefile is for the IP::Country extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/IP/Country.pm]
#     AUTHOR => q[Nigel Wetters <nwetters@cpan.org>]
#     NAME => q[IP::Country]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/IP/Country.pm]
...
PARENT_NAME = IP
DLBASE = $(BASEEXT)
VERSION_FROM = lib/IP/Country.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/IP/Country.pm \
	lib/IP/Country/Fast.pm \
	lib/IP/Country/Medium.pm \
	lib/IP/Country/Slow.pm \
	rdbms_reg.pl
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/IP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/IP
...
TO_INST_PM = lib/IP/Country.pm \
	lib/IP/Country/Fast.pm \
	lib/IP/Country/Fast/cc.gif \
	lib/IP/Country/Fast/ip.gif \
	lib/IP/Country/Medium.pm \
	lib/IP/Country/Slow.pm \
	rdbms_reg.pl \
	sorted_ranges2dbm.pl

PM_TO_BLIB = lib/IP/Country/Fast/cc.gif \
	blib/lib/IP/Country/Fast/cc.gif \
	lib/IP/Country/Medium.pm \
	blib/lib/IP/Country/Medium.pm \
	lib/IP/Country/Fast.pm \
	blib/lib/IP/Country/Fast.pm \
	rdbms_reg.pl \
	blib/lib/IP/rdbms_reg.pl \
	sorted_ranges2dbm.pl \
	blib/lib/IP/sorted_ranges2dbm.pl \
	lib/IP/Country/Slow.pm \
	blib/lib/IP/Country/Slow.pm \
	lib/IP/Country.pm \
	blib/lib/IP/Country.pm \
	lib/IP/Country/Fast/ip.gif \
	blib/lib/IP/Country/Fast/ip.gif
...
manifypods : pure_all lib/IP/Country/Medium.pm \
	lib/IP/Country/Fast.pm \
	rdbms_reg.pl \
	lib/IP/Country/Slow.pm \
	lib/IP/Country.pm
	@$(POD2MAN) \
	lib/IP/Country/Medium.pm \
	$(INST_MAN3DIR)/IP::Country::Medium.$(MAN3EXT) \
	lib/IP/Country/Fast.pm \
	$(INST_MAN3DIR)/IP::Country::Fast.$(MAN3EXT) \
	rdbms_reg.pl \
	$(INST_MAN3DIR)/IP::rdbms_reg.$(MAN3EXT) \
	lib/IP/Country/Slow.pm \
	$(INST_MAN3DIR)/IP::Country::Slow.$(MAN3EXT) \
	lib/IP/Country.pm \
	$(INST_MAN3DIR)/IP::Country.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/IP/Country/Fast/cc.gif blib/lib/IP/Country/Medium.pm
	rm -f blib/lib/IP/Country/Fast.pm blib/lib/IP/rdbms_reg.pl
	rm -f blib/lib/IP/sorted_ranges2dbm.pl blib/lib/IP/Country/Slow.pm
	rm -f blib/lib/IP/Country.pm blib/lib/IP/Country/Fast/ip.gif
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"2,01,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>fast lookup of country codes from IP addresses</ABSTRACT>\n\t<AUTHOR>Nigel Wetters &lt;nwetters\@cpan.org&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/IP/Country/Fast/cc.gif blib/lib/IP/Country/Fast/cc.gif lib/IP/Country/Slow.pm blib/lib/IP/Country/Slow.pm lib/IP/Country.pm blib/lib/IP/Country.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/IP/Country/Medium.pm blib/lib/IP/Country/Medium.pm lib/IP/Country/Fast.pm blib/lib/IP/Country/Fast.pm rdbms_reg.pl blib/lib/IP/rdbms_reg.pl sorted_ranges2dbm.pl blib/lib/IP/sorted_ranges2dbm.pl}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/IP/Country/Fast/ip.gif blib/lib/IP/Country/Fast/ip.gif}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
